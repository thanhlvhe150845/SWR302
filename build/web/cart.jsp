<%-- 
    Document   : cart
    Created on : Mar 12, 2022, 3:40:05 PM
    Author     : citih
--%>
                        ...
                        <tbody class="align-middle">
                            ...
                            <c:forEach items="${o.items}" var="i">
                                <c:set var="tt" value="${tt+1}"></c:set>
                                    <tr>
                                        <td class="align-middle"><img src="" alt="" > ${tt}</td>
                                    <td class="align-middle">${i.product.product_name}</td>
                                    <td class="align-middle">${i.price}</td>
                                    <td class="align-middle">
                                        <div class="input-group quantity mx-auto" >
                                            <div class="input-group-btn">
                                                <button class="btn btn-sm btn-primary btn-minus" >
                                                    <a href="process?num=-1&id=${i.product.product_id}"><i class="fa fa-minus"></i></a> 
                                            ...
                                            <div class="input-group-btn">
                                                <button class="btn btn-sm btn-primary btn-plus">
                                                    <a href="process?num=1&id=${i.product.product_id}"><i class="fa fa-plus"></i></a> 
                                                </button>
                                            </div>
                                        </div>
                                    </td>
